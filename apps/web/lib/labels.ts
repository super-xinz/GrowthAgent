const labels:Record<string,string>={
  DRAFT:"草稿",INGESTED:"资料已抓取",READY:"分析完成",ANALYSIS_FAILED:"分析失败",SHADOW_RUNNING:"影子运行中",PAUSED:"已暂停",
  ...
  SHADOW_ONLY:"仅影子记录",ALLOW_REPLY:"允许回复",SKIP:"跳过",BLOCK:"禁止参与",ESCALATE_STOP:"停止并升级处理",
  SHADOW_RECORDED:"已写入影子记录",PUBLISHED_MOCK:"模拟发布完成",PUBLISHED:"已发布",
