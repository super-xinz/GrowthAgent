...
async def test_mock_brain_claims_keep_source_evidence():
    ...
    brain=await provider.generate_structured("product_brain_v1",{"product_name":"Pilot","sources":[{"id":"s1","content":"Pilot monitors explicit product recommendations and preserves audit evidence."}]},{})
