...
AI 已经解决了越来越多编程问题。开发软件从未如此容易，成本也正在快速趋近于零。

当“把产品做出来”不再是最难的事，真正稀缺的能力就变成了：**让产品被看见，并持续获得用户。**

创始人本该专注于持续交付产品、理解客户和解决真实问题，而不是把时间耗在管理私信与邮件、分配广告预算，以及机械地维护社交媒体内容上。但过去，他们往往只有两个选择：

1. 每年花费约 20 万美元聘请一名增长负责人；
2. 自己东拼西凑出一套昂贵、复杂且难以维护的增长工具栈。
...
只需提交产品网站或 GitHub 仓库链接，GrowthAgent 就会持续运行：

1. **理解产品**：自动梳理产品定位、目标用户、核心能力与卖点；
2. **发现需求**：在小红书上找到正在求推荐、寻找替代方案或讨论相关痛点的用户；
3. **判断机会**：结合需求匹配度、来源证据和发布风险，筛选最值得参与的讨论；
4. **持续互动**：生成有价值且克制的回复，持续跟进用户追问和后续对话；
5. **衡量结果**：记录每次互动带来的访问、注册与激活，让增长过程可以持续复盘。

当前版本聚焦小红书，未来可扩展至 X、抖音等更多内容与社交平台。

> **你负责把产品做出来，GrowthAgent 负责找到第一批用户。**

GrowthAgent 是一款本地优先、单用户自托管的需求发现与获客工具。它根据产品公开资料建立带证据的 Product Brain，在高匹配、低风险和严格频控的条件下发现并参与真实需求。

[产品界面](#产品界面) · [下载与启动](#下载与启动) · [模型配置](#模型-api-key) · [安全边界](#安全边界) · [开发与验证](#开发与验证)
